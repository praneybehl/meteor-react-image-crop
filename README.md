...
A responsive image cropping tool for React repackaged for Meteor.


### Adding it to your project

~~~
meteor add praneybehl:react-image-crop
~~~

This Meteor package is a wrapper around [React-Image-Crop](https://github.com/DominicTobias/react-image-crop)
